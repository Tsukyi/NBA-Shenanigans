...
try{
 ...
 await fits('draft');console.log('PHOTO CHECK:',await page.locator('.hero-player img').evaluateAll(imgs=>imgs.map(img=>({url:img.currentSrc,fallback:!!img.dataset.fallback}))));await shot('01-current-draft');
